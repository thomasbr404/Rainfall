...
function Mainmenu:load()
  ...
  local bgList = {"assets/MainBG1.png", "assets/MainBG2.png", "assets/MainBG3.png", "assets/MainBG4.png", "assets/MainBG5.png", "assets/MainBG6.png", "assets/MainBG7.png", "assets/MainBG8.png"}
  
  Mainmenu_Particles:load()
  mainBG = love.graphics.newImage(bgList[love.math.random(1,#bgList)])
